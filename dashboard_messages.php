...
<div id="main_wrapper">
    ...
    <div id="dashboard">
        ...
        <div class="utf_dashboard_navigation js-scrollbar">
            <div class="utf_dashboard_navigation_inner_block">
                <ul>
                    ...
                    <li class="active"><a href="dashboard_messages"><i class="sl sl-icon-envelope-open"></i>
                            Messages</a></li>
        ...
        <div class="utf_dashboard_content">
            <div class="row no-gutters border-chat margin-left-10 margin-right-10 margin-top-10">
                <div class="col-md-4 border-right padding-left-0 padding-right-0">
                ...
                <div class="col-md-8 padding-left-0 padding-right-0">
                    ...
                    <div class="chat-panel">
                        <div class="chat-panel-inner">
                            <div class="chat-left">
                                <div class="width-50 chat-bubble--left chat-bubble">
                                    hello
                                </div>
                            </div>
                            <div class="chat-right">
                                <div class="width-50 chat-bubble--right chat-bubble">
                                    hello
                                </div>
                            </div>
                            <div class="chat-left">
